...
test.describe('Time Saver API tests', () => {
  ...
  // // Test: Retrieve time savings stats by template task ID
  // test('GET /stats/template/{templateTaskId} - Retrieve stats by template task ID', async () => {
  //   const templateTaskId = 'example-template-task-id'; // Replace with actual ID
  //   const response = await apiContext.get(`/stats/template/${templateTaskId}`);
  //   expect(response.status()).toBe(200);

  //   const body = await response.json();
  //   expect(body).toHaveProperty('templateTaskId', templateTaskId);
  //   expect(body).toHaveProperty('stats');
  // });

  // // Test: Retrieve time savings stats by team
  // test('GET /stats/team/{team} - Retrieve stats by team', async () => {
  //   const team = 'example-team-name'; // Replace with actual team name
  //   const response = await apiContext.get(`/stats/team/${team}`);
  //   expect(response.status()).toBe(200);

  //   const body = await response.json();
  //   expect(body).toHaveProperty('team', team);
  //   expect(body).toHaveProperty('stats');
  // });

  // // Test: Retrieve all time savings stats
  // test('GET /stats/all - Retrieve all stats', async () => {
  //   const response = await apiContext.get(`/stats/all`);
  //   expect(response.status()).toBe(200);
  ...
  // // Test: Retrieve group savings division
  // test('GET /stats/group/division - Retrieve group savings division', async () => {
  //   const response = await apiContext.get(`/stats/group_division`);
  //   expect(response.status()).toBe(200);
  ...
  // test('GET /stats/template/{templateTaskId} - Unauthorized', async () => {
  //   // Simulate unauthorized request by removing token
  //   const unauthorizedContext = await request.newContext({
  ...
  //   const templateTaskId = 'example-template-task-id';
  //   const response = await unauthorizedContext.get(`/stats/template/${templateTaskId}`);
  //   expect(response.status()).toBe(401);
  // });

  // // Test: Template not found
  // test('GET /stats/template/{templateTaskId} - Template not found', async () => {
  //   const templateTaskId = 'non-existent-id'; // Use a non-existent templateTaskId
  //   const response = await apiContext.get(`/stats/template/${templateTaskId}`);
  ...
  test(`GET /getStats?team={team} - Retrieve time saved statistics for a given team`, async () => {
    ...
    const response = await apiContext.get(`/api/time-saver/getStats?team=${teamName}`);
    expect(response.status()).toBe(200);
  ...
  test(`GET /getStats?templateName={templateName} - Retrieve time saved statistics for a given template`, async () => {
    ...
    const response = await apiContext.get(`/api/time-saver/getStats?templateName=${templateName}`);
    expect(response.status()).toBe(200);
  ...
  test('GET /getDailyTimeSummary/team - Retrieve time saved per day per team', async () => {
    const response = await apiContext.get(`/api/time-saver/getDailyTimeSummary/team`);
    expect(response.status()).toBe(200);
  ...
  test('GET /getDailyTimeSummary/template - Retrieve time saved per day per template', async () => {
    const response = await apiContext.get(`/api/time-saver/getDailyTimeSummary/template`);
    expect(response.status()).toBe(200);
  ...
  test('GET /getTimeSummary/team - Retrieve time saved per team', async () => {
    const response = await apiContext.get(`/api/time-saver/getTimeSummary/team`);
    expect(response.status()).toBe(200);
  ...
  test('GET /getTimeSummary/template - Retrieve time saved per template', async () => {
    const response = await apiContext.get(`/api/time-saver/getTimeSummary/template`);
    expect(response.status()).toBe(200);
